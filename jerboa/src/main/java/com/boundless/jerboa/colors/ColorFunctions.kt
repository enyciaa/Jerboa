...
import com.boundless.jerboa.extensions.isValidHexidecimal
import com.boundless.jerboa.extensions.toIntWithinRange
import java.util.*
...
fun isNotValidRgb(
        ...
        green: Int,
        blue: Int
): Boolean = !isValidRgb(red, green, blue)

fun calculateColorBrightness(
        red: Int,
        green: Int,
        blue: Int
): Double {
